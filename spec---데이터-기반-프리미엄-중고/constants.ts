...
export const CATEGORIES: Category[] = [
  {
    ...
    parentId: null,
    children: [
      { id: '1-1', name: '스마트폰', type: CategoryType.DIGITAL, parentId: '1' },
      { id: '1-2', name: '노트북', type: CategoryType.DIGITAL, parentId: '1' },
      { id: '1-3', name: '오디오/헤드폰', type: CategoryType.DIGITAL, parentId: '1' },
    ],
  },
  {
    id: '2',
  ...
  },
  {
    ...
    parentId: null,
    children: [
      { id: '3-1', name: '콘서트', type: CategoryType.TICKET, parentId: '3' },
      { id: '3-2', name: '스포츠', type: CategoryType.TICKET, parentId: '3' },
      { id: '3-3', name: '뮤지컬/연극', type: CategoryType.TICKET, parentId: '3' },
    ],
  },
];
