...
import { CategoryType, TicketDetails, DeviceDetails } from '../types';
import { ArrowLeft, Share2, MoreHorizontal, MapPin, Calendar, CheckCircle2, ShieldCheck, MessageCircle, ShoppingBag } from 'lucide-react';
...
export const ProductDetail: React.FC = () => {
  ...
  if (!product) {
    return <div className="p-10 text-center pt-24">상품을 찾을 수 없습니다.</div>;
  }
